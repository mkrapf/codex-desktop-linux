...
test_launcher_template_sanity() {
    ...
    assert_occurrence_count "$REPO_DIR/scripts/lib/native-modules.sh" "--include=dev" "2"
...
test_launcher_warm_start_recovery() {
    local test_app_id="${CODEX_TEST_APP_ID:-cdxsmk}"
    info "Checking warm-start recovery after launcher SIGKILL"
    CODEX_TEST_APP_ID="$test_app_id" bash "$REPO_DIR/tests/launcher_warm_start_recovery.sh"
    CODEX_TEST_APP_ID="$test_app_id" CODEX_TEST_APPIMAGE_REMOUNT=1 \
        bash "$REPO_DIR/tests/launcher_warm_start_recovery.sh"
    CODEX_TEST_APP_ID="$test_app_id" CODEX_TEST_DISABLE_WARM_START=1 \
        bash "$REPO_DIR/tests/launcher_warm_start_recovery.sh"
    CODEX_TEST_APP_ID="$test_app_id" CODEX_TEST_KILL_DURING_PRELAUNCH=1 \
        bash "$REPO_DIR/tests/launcher_warm_start_recovery.sh"
    CODEX_TEST_APP_ID="$test_app_id" CODEX_TEST_DISABLE_PIDFD=1 \
        CODEX_TEST_NORMAL_LOCK_ONLY=1 bash "$REPO_DIR/tests/launcher_warm_start_recovery.sh"
    CODEX_TEST_APP_ID="$test_app_id" CODEX_TEST_DISABLE_PIDFD=1 \
        CODEX_TEST_KILL_DURING_PRELAUNCH=1 \
        bash "$REPO_DIR/tests/launcher_warm_start_recovery.sh"
}
